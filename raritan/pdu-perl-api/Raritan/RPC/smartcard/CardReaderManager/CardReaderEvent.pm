...
package Raritan::RPC::smartcard::CardReaderManager::CardReaderEvent;

use constant typeId => "smartcard.CardReaderManager.CardReaderEvent:1.0.0";
...
Raritan::RPC::Registry::registerCodecClass('smartcard.CardReaderManager.CardReaderEvent', 1, 0, 0, 'Raritan::RPC::smartcard::CardReaderManager::CardReaderEvent');
1;
