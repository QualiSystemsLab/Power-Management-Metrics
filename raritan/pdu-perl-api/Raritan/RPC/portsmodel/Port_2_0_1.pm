...
package Raritan::RPC::portsmodel::Port_2_0_1;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "portsmodel.Port:2.0.1";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::portsmodel::Port_2_0_1::typeId;
...
sub getProperties($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::portsmodel::Port_2_0_1::Properties::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setDetectionMode($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'mode'} = Raritan::RPC::portsmodel::Port_2_0_1::DetectionMode::encode($mode);
...
Raritan::RPC::Registry::registerProxyClass('portsmodel.Port', 2, 0, 1, 'Raritan::RPC::portsmodel::Port_2_0_1');
1;
