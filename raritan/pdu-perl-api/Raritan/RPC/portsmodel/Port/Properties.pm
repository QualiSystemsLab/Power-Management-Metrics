...
package Raritan::RPC::portsmodel::Port::Properties;
...
sub encode {
    ...
    $encoded->{'mode'} = Raritan::RPC::portsmodel::Port::DetectionMode::encode($in->{'mode'});
...
sub decode {
    ...
    $decoded->{'mode'} = Raritan::RPC::portsmodel::Port::DetectionMode::decode($agent, $in->{'mode'});
