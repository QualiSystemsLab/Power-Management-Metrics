...
package Raritan::RPC::assetmgrmodel::AssetStripConfig;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "assetmgrmodel.AssetStripConfig:1.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::assetmgrmodel::AssetStripConfig::typeId;
...
sub getStripSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::assetmgrmodel::AssetStripConfig::StripSettings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getRackUnitSettings($$$) {
    ...
    $$settings = Raritan::RPC::assetmgrmodel::AssetStripConfig::RackUnitSettings::decode($agent, $rsp->{'settings'});
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
}
...
sub getAllRackUnitSettings($) {
    ...
    for (my $i0 = 0; $i0 <= $#{$rsp->{'_ret_'}}; $i0++) {
        $_ret_->[$i0] = Raritan::RPC::assetmgrmodel::AssetStripConfig::RackUnitSettings::decode($agent, $rsp->{'_ret_'}->[$i0]);
    }
    return $_ret_;
}
...
sub setMultipleRackUnitSettings($$) {
    ...
    foreach my $key0 (keys %{$settings}) {
        ...
        my $elem0 = {};
        $elem0->{'key'} = 1 * $key0;
        $elem0->{'value'} = Raritan::RPC::assetmgrmodel::AssetStripConfig::RackUnitSettings::encode($value0);
...
Raritan::RPC::Registry::registerProxyClass('assetmgrmodel.AssetStripConfig', 1, 0, 0, 'Raritan::RPC::assetmgrmodel::AssetStripConfig');
1;
