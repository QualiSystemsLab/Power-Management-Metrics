...
package Raritan::RPC::assetmgrmodel::AssetStrip_2_0_2;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "assetmgrmodel.AssetStrip:2.0.2";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::assetmgrmodel::AssetStrip_2_0_2::typeId;
...
sub getDeviceInfo($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::assetmgrmodel::AssetStrip_2_0_2::DeviceInfo::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getStripInfo($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::assetmgrmodel::AssetStrip_2_0_2::StripInfo::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getRackUnitInfo($$$) {
    ...
    $$info = Raritan::RPC::assetmgrmodel::AssetStrip_2_0_2::RackUnitInfo::decode($agent, $rsp->{'info'});
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
}
...
sub getAllRackUnitInfos($) {
    ...
    for (my $i0 = 0; $i0 <= $#{$rsp->{'_ret_'}}; $i0++) {
        $_ret_->[$i0] = Raritan::RPC::assetmgrmodel::AssetStrip_2_0_2::RackUnitInfo::decode($agent, $rsp->{'_ret_'}->[$i0]);
    }
    return $_ret_;
}
...
sub getTag($$$$) {
    ...
    $$tagInfo = Raritan::RPC::assetmgrmodel::AssetStrip_2_0_2::TagInfo::decode($agent, $rsp->{'tagInfo'});
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
}
...
sub getAllTags($) {
    ...
    $_ret_ = [];
    for (my $i0 = 0; $i0 <= $#{$rsp->{'_ret_'}}; $i0++) {
        $_ret_->[$i0] = Raritan::RPC::assetmgrmodel::AssetStrip_2_0_2::TagInfo::decode($agent, $rsp->{'_ret_'}->[$i0]);
    }
    return $_ret_;
}
...
sub getExtensionTags($$$) {
    ...
    for (my $i0 = 0; $i0 <= $#{$rsp->{'tags'}}; $i0++) {
        $$tags->[$i0] = Raritan::RPC::assetmgrmodel::AssetStrip_2_0_2::TagInfo::decode($agent, $rsp->{'tags'}->[$i0]);
    }
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
...
Raritan::RPC::Registry::registerProxyClass('assetmgrmodel.AssetStrip', 2, 0, 2, 'Raritan::RPC::assetmgrmodel::AssetStrip_2_0_2');
1;
