...
package Raritan::RPC::firmware::Firmware_2_0_0;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "firmware.Firmware:2.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::firmware::Firmware_2_0_0::typeId;
...
Raritan::RPC::Registry::registerProxyClass('firmware.Firmware', 2, 0, 0, 'Raritan::RPC::firmware::Firmware_2_0_0');
1;
