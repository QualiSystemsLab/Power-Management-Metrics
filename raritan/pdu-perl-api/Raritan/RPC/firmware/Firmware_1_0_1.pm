...
package Raritan::RPC::firmware::Firmware_1_0_1;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "firmware.Firmware:1.0.1";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::firmware::Firmware_1_0_1::typeId;
...
Raritan::RPC::Registry::registerProxyClass('firmware.Firmware', 1, 0, 1, 'Raritan::RPC::firmware::Firmware_1_0_1');
1;
