...
package Raritan::RPC::usermgmt::UserManager;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "usermgmt.UserManager:1.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::usermgmt::UserManager::typeId;
...
Raritan::RPC::Registry::registerProxyClass('usermgmt.UserManager', 1, 0, 0, 'Raritan::RPC::usermgmt::UserManager');
1;
