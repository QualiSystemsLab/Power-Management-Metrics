...
package Raritan::RPC::cfg::Cfg;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "cfg.Cfg:1.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::cfg::Cfg::typeId;
...
Raritan::RPC::Registry::registerProxyClass('cfg.Cfg', 1, 0, 0, 'Raritan::RPC::cfg::Cfg');
1;
