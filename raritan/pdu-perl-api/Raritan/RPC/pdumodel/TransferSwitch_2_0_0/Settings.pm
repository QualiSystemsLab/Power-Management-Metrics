...
package Raritan::RPC::pdumodel::TransferSwitch_2_0_0::Settings;
...
sub encode {
    ...
    $encoded->{'powerQuality'} = Raritan::RPC::pdumodel::TransferSwitch_2_0_0::PowerQualitySettings::encode($in->{'powerQuality'});
    return $encoded;
}
...
sub decode {
    ...
    $decoded->{'powerQuality'} = Raritan::RPC::pdumodel::TransferSwitch_2_0_0::PowerQualitySettings::decode($agent, $in->{'powerQuality'});
    return $decoded;
}
