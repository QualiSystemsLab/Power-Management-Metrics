...
package Raritan::RPC::pdumodel::Outlet_1_5_6::PowerControlEvent;

use constant typeId => "pdumodel.Outlet_1_5_6.PowerControlEvent:1.0.0";
...
Raritan::RPC::Registry::registerCodecClass('pdumodel.Outlet_1_5_6.PowerControlEvent', 1, 0, 0, 'Raritan::RPC::pdumodel::Outlet_1_5_6::PowerControlEvent');
1;
