...
package Raritan::RPC::pdumodel::TransferSwitch_1_0_2::Settings;
...
sub encode {
    ...
    $encoded->{'powerQuality'} = Raritan::RPC::pdumodel::TransferSwitch_1_0_2::PowerQualitySettings::encode($in->{'powerQuality'});
    return $encoded;
}
...
sub decode {
    ...
    $decoded->{'powerQuality'} = Raritan::RPC::pdumodel::TransferSwitch_1_0_2::PowerQualitySettings::decode($agent, $in->{'powerQuality'});
    return $decoded;
}
