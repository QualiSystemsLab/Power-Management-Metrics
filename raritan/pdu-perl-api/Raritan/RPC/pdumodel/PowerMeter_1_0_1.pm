...
package Raritan::RPC::pdumodel::PowerMeter_1_0_1;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "pdumodel.PowerMeter:1.0.1";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::pdumodel::PowerMeter_1_0_1::typeId;
...
sub getConfig($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::PowerMeter_1_0_1::Config::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSensors($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::PowerMeter_1_0_1::Sensors::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::PowerMeter_1_0_1::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getEnergyPulseSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::PowerMeter_1_0_1::EnergyPulseSettings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setEnergyPulseSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::pdumodel::PowerMeter_1_0_1::EnergyPulseSettings::encode($settings);
...
Raritan::RPC::Registry::registerProxyClass('pdumodel.PowerMeter', 1, 0, 1, 'Raritan::RPC::pdumodel::PowerMeter_1_0_1');
1;
