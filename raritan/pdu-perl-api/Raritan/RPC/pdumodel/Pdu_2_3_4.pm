...
package Raritan::RPC::pdumodel::Pdu_2_3_4;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "pdumodel.Pdu:2.3.4";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::pdumodel::Pdu_2_3_4::typeId;
...
sub getMetaData($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_2_3_4::MetaData::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSensors($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_2_3_4::Sensors::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_2_3_4::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::pdumodel::Pdu_2_3_4::Settings::encode($settings);
...
sub getStatistic($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_2_3_4::Statistic::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getOutletSequenceState($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Pdu_2_3_4::OutletSequenceState::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
Raritan::RPC::Registry::registerProxyClass('pdumodel.Pdu', 2, 3, 4, 'Raritan::RPC::pdumodel::Pdu_2_3_4');
1;
