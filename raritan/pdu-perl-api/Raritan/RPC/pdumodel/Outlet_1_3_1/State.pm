...
package Raritan::RPC::pdumodel::Outlet_1_3_1::State;
...
sub encode {
    ...
    $encoded->{'ledState'} = Raritan::RPC::pdumodel::Outlet_1_3_1::LedState::encode($in->{'ledState'});
...
sub decode {
    ...
    $decoded->{'ledState'} = Raritan::RPC::pdumodel::Outlet_1_3_1::LedState::decode($agent, $in->{'ledState'});
