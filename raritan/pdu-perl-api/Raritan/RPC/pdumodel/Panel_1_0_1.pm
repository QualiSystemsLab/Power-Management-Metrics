...
package Raritan::RPC::pdumodel::Panel_1_0_1;

use parent qw(Raritan::RPC::pdumodel::PowerMeter_1_0_1);

use constant typeId => "pdumodel.Panel:1.0.1";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::pdumodel::Panel_1_0_1::typeId;
...
sub getPanelSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Panel_1_0_1::PanelSettings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setPanelSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::pdumodel::Panel_1_0_1::PanelSettings::encode($settings);
...
Raritan::RPC::Registry::registerProxyClass('pdumodel.Panel', 1, 0, 1, 'Raritan::RPC::pdumodel::Panel_1_0_1');
1;
