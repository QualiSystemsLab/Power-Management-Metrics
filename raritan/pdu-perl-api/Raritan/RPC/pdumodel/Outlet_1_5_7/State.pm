...
package Raritan::RPC::pdumodel::Outlet_1_5_7::State;
...
sub encode {
    ...
    $encoded->{'ledState'} = Raritan::RPC::pdumodel::Outlet_1_5_7::LedState::encode($in->{'ledState'});
...
sub decode {
    ...
    $decoded->{'ledState'} = Raritan::RPC::pdumodel::Outlet_1_5_7::LedState::decode($agent, $in->{'ledState'});
