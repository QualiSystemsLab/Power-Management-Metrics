...
package Raritan::RPC::pdumodel::Outlet_2_0_0::State;
...
sub encode {
    ...
    $encoded->{'ledState'} = Raritan::RPC::pdumodel::Outlet_2_0_0::LedState::encode($in->{'ledState'});
...
sub decode {
    ...
    $decoded->{'ledState'} = Raritan::RPC::pdumodel::Outlet_2_0_0::LedState::decode($agent, $in->{'ledState'});
