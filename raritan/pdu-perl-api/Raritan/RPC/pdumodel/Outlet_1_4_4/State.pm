...
package Raritan::RPC::pdumodel::Outlet_1_4_4::State;
...
sub encode {
    ...
    $encoded->{'ledState'} = Raritan::RPC::pdumodel::Outlet_1_4_4::LedState::encode($in->{'ledState'});
...
sub decode {
    ...
    $decoded->{'ledState'} = Raritan::RPC::pdumodel::Outlet_1_4_4::LedState::decode($agent, $in->{'ledState'});
