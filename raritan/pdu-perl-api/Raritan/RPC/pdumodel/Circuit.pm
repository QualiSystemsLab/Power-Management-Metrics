...
package Raritan::RPC::pdumodel::Circuit;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "pdumodel.Circuit:1.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::pdumodel::Circuit::typeId;
...
sub getConfig($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Circuit::Config::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSensors($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Circuit::Sensors::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::pdumodel::Circuit::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
Raritan::RPC::Registry::registerProxyClass('pdumodel.Circuit', 1, 0, 0, 'Raritan::RPC::pdumodel::Circuit');
1;
