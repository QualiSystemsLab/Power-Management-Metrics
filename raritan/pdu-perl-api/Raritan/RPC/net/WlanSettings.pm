...
package Raritan::RPC::net::WlanSettings;
...
sub encode {
    ...
    $encoded->{'eap'} = Raritan::RPC::net::EapAuthSettings::encode($in->{'eap'});
    return $encoded;
}
...
sub decode {
    ...
    $decoded->{'eap'} = Raritan::RPC::net::EapAuthSettings::decode($agent, $in->{'eap'});
    return $decoded;
}
