...
package Raritan::RPC::serial::SerialPort_3_0_0::ModemEvent;

use constant typeId => "serial.SerialPort_3_0_0.ModemEvent:1.0.0";
...
Raritan::RPC::Registry::registerCodecClass('serial.SerialPort_3_0_0.ModemEvent', 1, 0, 0, 'Raritan::RPC::serial::SerialPort_3_0_0::ModemEvent');
1;
