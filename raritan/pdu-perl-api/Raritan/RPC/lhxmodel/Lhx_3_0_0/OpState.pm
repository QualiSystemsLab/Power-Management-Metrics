...
package Raritan::RPC::lhxmodel::Lhx_3_0_0::OpState;
...
sub encode {
    ...
    $encoded->{'alertStatus'} = Raritan::RPC::lhxmodel::Lhx_3_0_0::AlertStatus::encode($in->{'alertStatus'});
...
sub decode {
    ...
    $decoded->{'alertStatus'} = Raritan::RPC::lhxmodel::Lhx_3_0_0::AlertStatus::decode($agent, $in->{'alertStatus'});
