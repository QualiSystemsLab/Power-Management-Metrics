...
package Raritan::RPC::lhxmodel::Lhx_1_1_1::OpState;
...
sub encode {
    ...
    $encoded->{'alertStatus'} = Raritan::RPC::lhxmodel::Lhx_1_1_1::AlertStatus::encode($in->{'alertStatus'});
...
sub decode {
    ...
    $decoded->{'alertStatus'} = Raritan::RPC::lhxmodel::Lhx_1_1_1::AlertStatus::decode($agent, $in->{'alertStatus'});
