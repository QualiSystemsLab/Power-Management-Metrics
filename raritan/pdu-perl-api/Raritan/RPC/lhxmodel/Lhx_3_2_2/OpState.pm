...
package Raritan::RPC::lhxmodel::Lhx_3_2_2::OpState;
...
sub encode {
    ...
    $encoded->{'alertStatus'} = Raritan::RPC::lhxmodel::Lhx_3_2_2::AlertStatus::encode($in->{'alertStatus'});
...
sub decode {
    ...
    $decoded->{'alertStatus'} = Raritan::RPC::lhxmodel::Lhx_3_2_2::AlertStatus::decode($agent, $in->{'alertStatus'});
