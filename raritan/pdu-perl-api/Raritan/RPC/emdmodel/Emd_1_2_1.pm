...
package Raritan::RPC::emdmodel::Emd_1_2_1;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "emdmodel.Emd:1.2.1";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::emdmodel::Emd_1_2_1::typeId;
...
sub getMetaData($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::emdmodel::Emd_1_2_1::MetaData::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::emdmodel::Emd_1_2_1::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::emdmodel::Emd_1_2_1::Settings::encode($settings);
...
Raritan::RPC::Registry::registerProxyClass('emdmodel.Emd', 1, 2, 1, 'Raritan::RPC::emdmodel::Emd_1_2_1');
1;
