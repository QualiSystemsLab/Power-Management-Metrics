...
package Raritan::RPC::sensors::NumericSensor_4_0_1::ReadingChangedEvent;

use constant typeId => "sensors.NumericSensor_4_0_1.ReadingChangedEvent:1.0.0";
...
Raritan::RPC::Registry::registerCodecClass('sensors.NumericSensor_4_0_1.ReadingChangedEvent', 1, 0, 0, 'Raritan::RPC::sensors::NumericSensor_4_0_1::ReadingChangedEvent');
1;
