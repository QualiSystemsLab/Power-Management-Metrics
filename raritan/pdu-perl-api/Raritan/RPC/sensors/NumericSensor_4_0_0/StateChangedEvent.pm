...
package Raritan::RPC::sensors::NumericSensor_4_0_0::StateChangedEvent;

use constant typeId => "sensors.NumericSensor_4_0_0.StateChangedEvent:1.0.0";
...
Raritan::RPC::Registry::registerCodecClass('sensors.NumericSensor_4_0_0.StateChangedEvent', 1, 0, 0, 'Raritan::RPC::sensors::NumericSensor_4_0_0::StateChangedEvent');
1;
