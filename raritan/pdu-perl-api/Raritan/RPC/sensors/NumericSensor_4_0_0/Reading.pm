...
package Raritan::RPC::sensors::NumericSensor_4_0_0::Reading;
...
sub encode {
    ...
    $encoded->{'status'} = Raritan::RPC::sensors::NumericSensor_4_0_0::Reading::Status::encode($in->{'status'});
...
sub decode {
    ...
    $decoded->{'status'} = Raritan::RPC::sensors::NumericSensor_4_0_0::Reading::Status::decode($agent, $in->{'status'});
