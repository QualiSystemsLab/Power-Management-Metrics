...
package Raritan::RPC::sensors::NumericSensor_3_0_1::Reading;
...
sub encode {
    ...
    $encoded->{'status'} = Raritan::RPC::sensors::NumericSensor_3_0_1::Reading::Status::encode($in->{'status'});
...
sub decode {
    ...
    $decoded->{'status'} = Raritan::RPC::sensors::NumericSensor_3_0_1::Reading::Status::decode($agent, $in->{'status'});
