...
package Raritan::RPC::sensors::Logger_2_0_0;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "sensors.Logger:2.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::sensors::Logger_2_0_0::typeId;
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::sensors::Logger_2_0_0::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSensorRecords($$$$$) {
    ...
    for (my $i0 = 0; $i0 <= $#{$rsp->{'recs'}}; $i0++) {
        $$recs->[$i0] = Raritan::RPC::sensors::Logger_2_0_0::Record::decode($agent, $rsp->{'recs'}->[$i0]);
    }
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
...
sub getSensorTimedRecords($$$$$) {
    ...
    $$recs = [];
    for (my $i0 = 0; $i0 <= $#{$rsp->{'recs'}}; $i0++) {
        $$recs->[$i0] = Raritan::RPC::sensors::Logger_2_0_0::TimedRecord::decode($agent, $rsp->{'recs'}->[$i0]);
    }
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
...
sub getLoggedSensors($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::sensors::Logger_2_0_0::SensorSet::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setLoggedSensors($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'sensors'} = Raritan::RPC::sensors::Logger_2_0_0::SensorSet::encode($sensors);
...
sub getLogRow($$$) {
    ...
    $$row = Raritan::RPC::sensors::Logger_2_0_0::LogRow::decode($agent, $rsp->{'row'});
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
}

Raritan::RPC::Registry::registerProxyClass('sensors.Logger', 2, 0, 0, 'Raritan::RPC::sensors::Logger_2_0_0');
1;
