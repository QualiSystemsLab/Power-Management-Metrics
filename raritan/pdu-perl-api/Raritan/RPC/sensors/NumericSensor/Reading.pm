...
package Raritan::RPC::sensors::NumericSensor::Reading;
...
sub encode {
    ...
    $encoded->{'status'} = Raritan::RPC::sensors::NumericSensor::Reading::Status::encode($in->{'status'});
...
sub decode {
    ...
    $decoded->{'status'} = Raritan::RPC::sensors::NumericSensor::Reading::Status::decode($agent, $in->{'status'});
