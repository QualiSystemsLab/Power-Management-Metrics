...
package Raritan::RPC::sensors::Logger_2_1_4;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "sensors.Logger:2.1.4";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::sensors::Logger_2_1_4::typeId;
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::sensors::Logger_2_1_4::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getSensorRecords($$$$$) {
    ...
    for (my $i0 = 0; $i0 <= $#{$rsp->{'recs'}}; $i0++) {
        $$recs->[$i0] = Raritan::RPC::sensors::Logger_2_1_4::Record::decode($agent, $rsp->{'recs'}->[$i0]);
    }
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
...
sub getSensorTimedRecords($$$$$) {
    ...
    $$recs = [];
    for (my $i0 = 0; $i0 <= $#{$rsp->{'recs'}}; $i0++) {
        $$recs->[$i0] = Raritan::RPC::sensors::Logger_2_1_4::TimedRecord::decode($agent, $rsp->{'recs'}->[$i0]);
    }
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
...
sub getLoggedSensors($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::sensors::Logger_2_1_4::SensorSet::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setLoggedSensors($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'sensors'} = Raritan::RPC::sensors::Logger_2_1_4::SensorSet::encode($sensors);
...
sub enableSensors($$) {
    ...
    my $args = {};
    $args->{'sensors'} = Raritan::RPC::sensors::Logger_2_1_4::SensorSet::encode($sensors);
    my $rsp = $agent->json_rpc($self->{'rid'}, 'enableSensors', $args);
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
}
...
sub disableSensors($$) {
    ...
    my $args = {};
    $args->{'sensors'} = Raritan::RPC::sensors::Logger_2_1_4::SensorSet::encode($sensors);
    my $rsp = $agent->json_rpc($self->{'rid'}, 'disableSensors', $args);
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
}
...
sub isSensorEnabled($$) {
    ...
    my $args = {};
    $args->{'sensor'} = Raritan::RPC::ObjectCodec::encode($sensor);
    my $rsp = $agent->json_rpc($self->{'rid'}, 'isSensorEnabled', $args);
    my $_ret_;
    $_ret_ = ($rsp->{'_ret_'}) ? 1 : 0;
    return $_ret_;
}
...
sub isSlotEnabled($$) {
    ...
    my $args = {};
    $args->{'slot'} = Raritan::RPC::ObjectCodec::encode($slot);
    my $rsp = $agent->json_rpc($self->{'rid'}, 'isSlotEnabled', $args);
    my $_ret_;
    $_ret_ = ($rsp->{'_ret_'}) ? 1 : 0;
    return $_ret_;
}
...
sub getLogRow($$$) {
    ...
    $$row = Raritan::RPC::sensors::Logger_2_1_4::LogRow::decode($agent, $rsp->{'row'});
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
}

Raritan::RPC::Registry::registerProxyClass('sensors.Logger', 2, 1, 4, 'Raritan::RPC::sensors::Logger_2_1_4');
1;
