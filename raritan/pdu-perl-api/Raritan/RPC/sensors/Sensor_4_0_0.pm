...
package Raritan::RPC::sensors::Sensor_4_0_0;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "sensors.Sensor:4.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::sensors::Sensor_4_0_0::typeId;
...
sub getTypeSpec($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::sensors::Sensor_4_0_0::TypeSpec::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
Raritan::RPC::Registry::registerProxyClass('sensors.Sensor', 4, 0, 0, 'Raritan::RPC::sensors::Sensor_4_0_0');
1;
