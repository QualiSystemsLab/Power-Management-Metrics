...
package Raritan::RPC::security::Security_3_0_1;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "security.Security:3.0.1";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::security::Security_3_0_1::typeId;
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::security::Security_3_0_1::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::security::Security_3_0_1::Settings::encode($settings);
...
Raritan::RPC::Registry::registerProxyClass('security.Security', 3, 0, 1, 'Raritan::RPC::security::Security_3_0_1');
1;
