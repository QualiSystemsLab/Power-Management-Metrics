...
package Raritan::RPC::luaservice::Environment_2_0_0;

sub encode {
    my ($in) = @_;
    my $encoded = {};
    $encoded->{'maxScriptMemoryGrowth'} = 1 * $in->{'maxScriptMemoryGrowth'};
...
sub decode {
    my ($agent, $in) = @_;
    my $decoded = {};
    $decoded->{'maxScriptMemoryGrowth'} = $in->{'maxScriptMemoryGrowth'};
