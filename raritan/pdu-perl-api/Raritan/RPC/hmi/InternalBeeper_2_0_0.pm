...
package Raritan::RPC::hmi::InternalBeeper_2_0_0;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "hmi.InternalBeeper:2.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::hmi::InternalBeeper_2_0_0::typeId;
...
Raritan::RPC::Registry::registerProxyClass('hmi.InternalBeeper', 2, 0, 0, 'Raritan::RPC::hmi::InternalBeeper_2_0_0');
1;
