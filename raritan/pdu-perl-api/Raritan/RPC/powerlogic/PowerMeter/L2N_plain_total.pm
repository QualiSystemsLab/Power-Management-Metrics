...
package Raritan::RPC::powerlogic::PowerMeter::L2N_plain_total;
...
sub encode {
    ...
    $encoded->{'total'} = Raritan::RPC::powerlogic::PowerMeter::MinMaxReading::encode($in->{'total'});
    return $encoded;
}
...
sub decode {
    ...
    $decoded->{'total'} = Raritan::RPC::powerlogic::PowerMeter::MinMaxReading::decode($agent, $in->{'total'});
    return $decoded;
}
