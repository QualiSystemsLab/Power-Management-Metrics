...
package Raritan::RPC::peripheral::DeviceSlot_2_0_0;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "peripheral.DeviceSlot:2.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::peripheral::DeviceSlot_2_0_0::typeId;
...
sub assign($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'devid'} = Raritan::RPC::peripheral::DeviceID_2_0_0::encode($devid);
...
sub assignAddress($$$) {
    ...
    $args->{'address'} = Raritan::RPC::peripheral::Address_2_0_0::encode($address);
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::peripheral::DeviceSlot_2_0_0::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub setSettings($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'settings'} = Raritan::RPC::peripheral::DeviceSlot_2_0_0::Settings::encode($settings);
...
Raritan::RPC::Registry::registerProxyClass('peripheral.DeviceSlot', 2, 0, 0, 'Raritan::RPC::peripheral::DeviceSlot_2_0_0');
1;
