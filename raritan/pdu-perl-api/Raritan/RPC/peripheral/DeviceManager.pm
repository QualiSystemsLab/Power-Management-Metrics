...
package Raritan::RPC::peripheral::DeviceManager;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "peripheral.DeviceManager:1.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::peripheral::DeviceManager::typeId;
...
sub getSettings($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::peripheral::DeviceManager::Settings::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getMetaData($) {
    ...
    my $_ret_;
    $_ret_ = Raritan::RPC::peripheral::DeviceManager::MetaData::decode($agent, $rsp->{'_ret_'});
    return $_ret_;
}
...
sub getDeviceTypeInfos($) {
    ...
    $_ret_ = [];
    for (my $i0 = 0; $i0 <= $#{$rsp->{'_ret_'}}; $i0++) {
        $_ret_->[$i0] = Raritan::RPC::peripheral::DeviceManager::DeviceTypeInfo::decode($agent, $rsp->{'_ret_'}->[$i0]);
    }
    return $_ret_;
}

Raritan::RPC::Registry::registerProxyClass('peripheral.DeviceManager', 1, 0, 0, 'Raritan::RPC::peripheral::DeviceManager');
1;
