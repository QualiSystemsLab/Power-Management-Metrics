...
package Raritan::RPC::webcam::StorageManager_1_0_1::StorageImage;
...
sub encode {
    ...
    $encoded->{'metaData'} = Raritan::RPC::webcam::StorageManager_1_0_1::StorageMetaData::encode($in->{'metaData'});
    return $encoded;
}
...
sub decode {
    ...
    $decoded->{'metaData'} = Raritan::RPC::webcam::StorageManager_1_0_1::StorageMetaData::decode($agent, $in->{'metaData'});
    return $decoded;
}
